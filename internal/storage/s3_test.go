...
func TestListObjectsTree(t *testing.T) {
	...
	if _, err := listObjectsTree(context.Background(), "b", "", list, onPage, defaultShardedDiscoveryConcurrency, 0, nil); err != nil {
...
func TestListObjectsTreeConcurrencyBounded(t *testing.T) {
	...
	if _, err := listObjectsTree(context.Background(), "b", "", list, onPage, concurrency, 0, nil); err != nil {
		t.Fatalf("listObjectsTree: %v", err)
	}
	if count != n {
...
func TestListObjectsTreeListErrorPropagates(t *testing.T) {
	...
	_, err := listObjectsTree(context.Background(), "b", "", list, func([]Object) error { return nil }, defaultShardedDiscoveryConcurrency, 0, nil)
...
func TestListObjectsTreeFailedPrefixDoesNotAbortWalk(t *testing.T) {
	...
	_, err := listObjectsTree(context.Background(), "b", "", list, func(objs []Object) error {
		...
		return nil
	}, defaultShardedDiscoveryConcurrency, 0, nil)
...
func TestListObjectsTreeReportsCappedPrefixErrors(t *testing.T) {
	...
	_, err := listObjectsTree(context.Background(), "b", "", list, func([]Object) error { return nil }, 2, 0, nil)
	if err == nil {
...
func TestListObjectsTreeOnPageErrorPropagates(t *testing.T) {
	...
	_, err := listObjectsTree(context.Background(), "b", "", list, func([]Object) error { return wantErr }, defaultShardedDiscoveryConcurrency, 0, nil)
	if !errors.Is(err, wantErr) {
		t.Errorf("got err %v, want %v", err, wantErr)
	}
}
